...
Not all NHS sites can access the main training site I use for the Introduction to R and R Studio so here are the details for the Prework with images in a form that I hope can be viewed by all sites:
