...
knitr::include_graphics("img/chaffinch-drawing-s.jpg")
```
...
Unfortunately, it looks like they render better on the index.Rmd file and not on a post. The slides look the same (with lost formats and no interactivity) whether the link is to the self-contained html in a repository on my computer or to the url.
